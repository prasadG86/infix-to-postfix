...
{
 changes.push({'stack':stack.clone(), 'output':output, 'desc':'read \')\' and pop from stackuntil \'(\''})



while( stack.last() != '(')//as long as lower or equal preccompared to stack, pop it)
...
function showStack(stack){
 ...
 new Path.Line({from: [fr.l, fr.b - 40*i], to: [fr.l + fr.w, fr.b - 40*i], strokeColor: 'black',
strokeWidth:2});
 }
 view.update();
}